...
class MessageHandler:
    ...
    def _serialize_scather_gather_aggregator_message(client : str, type:str, key : str, values: str):
        ...
        return message_protocol.internal.serialize(message_protocol.internal.InternalMessageType.SCATHER_GATHER_AGGREGATOR_TO_SCATHER_GATHER_PAIR_JOINER, client, message_id, parsedMessage, message_id=message_id)
