...
from entities.filters.usd_filter_q4.message_handler.message_handler import MessageHandler as USDFilterMessageHandler
...
def main():
    ...
    def _handle_sigterm(signum, frame):
        logging.info("SIGTERM received in usd filter q4")
